---
title: 主题效果预览
createTime: 2026/02/08 15:58:50
permalink: /more/zhu-ti-yu-lan/
sidebar: false
---

::: info  
由于本blog未开启全部md配置，此处可能有部分效果显示不完全，可以查看原项目[主题效果预览](https://theme-plume.vuejs.press/article/0lk24ty5/)
:::
