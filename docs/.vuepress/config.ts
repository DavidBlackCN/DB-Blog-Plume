...
export default defineUserConfig({
  ...
  head: [
    // 配置站点图标
    ['link', { rel: 'icon', type: 'image/png', href: './avatar/davidblack-round.png' }],   
  ],
  ...
  theme: plumeTheme({
    ...
    /**
     ...
     markdown: {
       ...
       pdf: false,          // 启用 PDF 嵌入 @[pdf](/xxx.pdf)
     ...
     */
    replaceAssets: 'https://mirror.davidblackcn.cc',
